    ...
    public AlugarCarros(){
        ...
        registrar.addActionListener(new ActionListener() { // USA O MÉTODO DA BIBLIOTECA AWT, PASSANDO actionPerformed, //
            public void actionPerformed(ActionEvent e){   // COMO PARÂMETRO.                                           //
                JOptionPane.showMessageDialog(AlugarCarros.this, "Aluguel Registrado!"); // POP-UP PARA CONFIRMAR QUE O REGISTRO //
                                                                                                // FOI SALVO                            //
                dispose(); // FECHA A JANELA ATUAL // 

                Menu menu = new Menu(); // INSTÂNCIA DE MENU, PARA ABRIR COMO NOVA TELA //
            }
        });
        ...
        voltar.addActionListener(new ActionListener() {  // USA O MÉTODO DA BIBLIOTECA AWT, PASSANDO actionPerformed, //
            public void actionPerformed(ActionEvent e){ // COMO PARÂMETRO.                                           //
                ...
                Menu menu1 = new Menu(); // INSTÂNCIA DE MENU, PARA ABRIR COMO UMA NOVA TELA. //
